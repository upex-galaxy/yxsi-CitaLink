      ...
      <div className="container flex max-w-5xl flex-col items-center justify-center gap-8 px-4 text-center md:px-6">
        ...
        <div className="flex flex-col gap-4 min-[400px]:flex-row">
          <Link
            ...
            className="inline-flex h-10 items-center justify-center rounded-md bg-emerald-600 px-8 text-sm font-medium text-white shadow transition-colors hover:bg-emerald-700 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-950 disabled:pointer-events-none disabled:opacity-50"
            prefetch={false}
          >
            Crear Cita
          </Link>
